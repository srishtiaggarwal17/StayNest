...
//       <h2 className="text-3xl font-bold text-center mb-10">Featured Hotel Rooms</h2>
  ...
  return (
    <section className="w-full py-8 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold mb-2">Featured Hotel Rooms</h2>
        <p className="text-gray-600 mb-5">
          Discover hand-picked rooms from top-rated hotels
        </p>
